  ...
  constructor() {
    ...
    let projectVierPuntNul: Project = {
      ...
      content: {
        ...
        verdict: "We hebben allemaal samen een mooi resultaat kunnen opleveren ondanks enkele tekortkomingen. Het was ook een zeer unieke kans om samen te werken met VanRoey en om aan de slag te gaan met Power Apps en Power Automate.",
        attachments: [
          {
            name: "Demo",
